...
<div class="container">
    <div class="row justify-content-center align-items-center vh-100">
        <div class="col-8">
            ...
            <form:form action="${pageContext.request.contextPath}/user/register" method="post" class="row g-3" modelAttribute="user">
                <div class="col-md-6">
                    <div class=" form-floating">
                        <form:input type="email" class="form-control" id="inputEmail4" placeholder="Email" path="userEmail" />
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <div class="form-floating ">
                            <form:input type="password" class="form-control" id="cPassword" name="cPassword" placeholder="Enter Password" path="userConfirmPassword"/>
                ...
                <div class="col-12 d-grid gap-4 mx-auto">
                    <a href="${pageContext.request.contextPath}/user/login" class="btn btn-link" id="login-link">LOG IN</a>
                </div>
            </form:form>
        </div>
    </div>
