...
<div class="container mt-4">
    <div class="row">
        <div class="col-4 d-flex flex-column align-items-center">
            <img src="${pageContext.request.contextPath}/student/photo?studentId=${studentId}" class="img-fluid"
                 alt="Student Photo" width="300" height="300">
        </div>
        <div class="col-8">
            <form:form action="${pageContext.request.contextPath}/student/edit" method="post"
                ...
                <div class="row mb-4 mt-5">
                    ...
                    <div class="col-md-8">
                        <form:input type="text" class="form-control" id="student-id" path="displayStudentId"
                                    readonly="true"/>
                    </div>
                </div>
                <div class="row mb-4">
                    ...
                    <div class="col-md-8">
                        <form:input type="text" class="form-control ms-2" id="studentName" name="studentName"
                                    path="studentName"/>
                    </div>
                </div>
                <div class="row mb-4">
                    ...
                    <div class="col-md-8">
                        <form:input type="date" id="student-dob" placeholder="Select date range" path="studentDob"
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"
                                      style="border: none;background-color: transparent">+95</span>
                            </div>
                            <form:input type="text" class="form-control" id="student-phone" name="studentPhone"
                                        path="studentPhone"/>
                        </div>
                        <small class="text-danger" id="phoneError" style="display: none;">Invalid phone number. Please
                            enter a 10-digit numeric phone number.</small>
                    </div>
                </div>
                <div class="row mb-4">
                    ...
                    <div class="col-md-8">
                        <div class="input-group">
                            <form:select class="form-control" id="student-education" name="studentEducation"
                                ...
                                <form:option
                                        value="Bachelor of Computer Science">Bachelor of Computer Science</form:option>
                            ...
                            <c:forEach items="${courses}" var="course">
                                <div class="form-check form-check-inline mb-2">
                                    ...
                                    <label class="form-check-label"
                                           for="${course.courseName}">${course.courseName}</label>
                                </div>
                            </c:forEach>
