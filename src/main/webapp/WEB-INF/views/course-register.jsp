...
<div class="container">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            ...
            <form:form class="row g-3 mt-4" action="${pageContext.request.contextPath}/course/register" method="post"
                       modelAttribute="course">
                <div class="col-md-10">
                    <div class="form-floating">
                        <form:input type="text" class="form-control" id="courseId" name="courseId"
                                    path="displayCourseId" readonly="true" value="COURSE_${courseCount}"/>
                    </div>
                </div>
                <div class="col-md-10">
                    <div class="form-floating">
                ...
                <div class="col-md-10">
                    <div class="form-floating">
                        <form:textarea type="textarea" class="form-control" id="courseDescription"
                                       name="courseDescription" path="courseDescription"
                                       placeholder="Course Description" cssStyle="height: 200px"/>
...
<c:choose>
    ...
    <c:when test="${'emptyError' eq 'emptyError'}">
        <div aria-live="polite" aria-atomic="true" class="position-relative"></div>
        <div class="position-fixed end-0 p-3" style="top:80px">
            <div class="toast text-bg-danger" role="alert" aria-live="assertive" aria-atomic="true"
                 data-autohide="false">
