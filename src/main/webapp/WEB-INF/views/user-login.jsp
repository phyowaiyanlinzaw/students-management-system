        ...
        <div class="col-4 rounded p-4" style=" color: #1e1b4b;">
            ...
            <form:form action="${pageContext.request.contextPath}/user/login" method="post" modelAttribute="user">
                <div class="form-floating mb-3">
                    <form:input type="text" class="form-control" id="userIdentifier" name="userIdentifier"
                                placeholder="Enter Email or Username" path="userIdentifier"/>
                    <label for="userIdentifier" class="form-label" style="color: #1e1b4b">Enter Email or
                        Username</label>
                </div>
                <div class="mb-3">
                ...
                <div class="col-12 d-grid gap-4 mx-auto">
                    <a href="${pageContext.request.contextPath}/user/register" class="btn btn-link" id="register-link">CREATE
                        AN ACCOUNT</a>
                </div>
