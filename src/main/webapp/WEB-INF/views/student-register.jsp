...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-8">
            ...
            <form:form action="${pageContext.request.contextPath}/student/register" method="post"
                ...
                <div class="row mb-4 mt-5">
                    ...
                    <div class="col-md-8">
                        <form:input type="text" class="form-control ms-2" id="student-id" path="displayStudentId"
                                    readonly="true" value="STUDENT_${studentCount}"/>
                    </div>
                </div>
                <div class="row mb-4">
                        ...
                        <div class="form-check d-flex flex-wrap">
                            <c:forEach items="${courses}" var="course">
                                <div class="form-check form-check-inline mb-2">
                                    <form:checkbox path="studentCourse" class="form-check-input" name="studentCourses"
